...
///layer pool1_3x3_s2
const int pool1_3x3_s2_in_channel = 16;
...
const int pool1_3x3_s2_out_height = 4;
const int pool1_3x3_s2_out_width = 4;
const int pool1_3x3_s2_stride = 2;

///layer pool1_norm1
const int pool1_norm1_in_channel = pool1_3x3_s2_in_channel;
const int pool1_norm1_in_height = pool1_3x3_s2_out_height;
const int pool1_norm1_in_width = pool1_3x3_s2_out_width;
