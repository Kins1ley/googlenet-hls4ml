...
/////header_insert_1/////
const int IMAGE_CH = 832; // image channel
const int IMAGE_H = 7;// image height
const int IMAGE_W = 7;// image width
/*
...
const int conv1_7x7_s2_kernel_num = 160;
...
const int conv1_7x7_s2_out_height = 7;
const int conv1_7x7_s2_out_width = 7;
