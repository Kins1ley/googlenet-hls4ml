...
/////header_insert_1/////
const int IMAGE_CH = 32; // image channel
...
const int conv1_7x7_s2_pad_top = 2;
const int conv1_7x7_s2_pad_bottom = 2;
const int conv1_7x7_s2_pad_left = 2;
const int conv1_7x7_s2_pad_right = 2;
...
const int conv1_7x7_s2_kernel_height = 5;
const int conv1_7x7_s2_kernel_width = 5;
