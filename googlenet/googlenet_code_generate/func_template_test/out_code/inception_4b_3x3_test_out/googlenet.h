...
void googlenet(
	...
	//global BRAM
	FIX_INT8 global_weight_7x7[NUM_WEIGHT_GLOBAL_7x7][OUT_CHANNEL_WEIGHT_GLOBAL_7x7][IN_CHANNEL_WEIGHT_GLOBAL_7x7][conv1_7x7_s2_kernel_height][conv1_7x7_s2_kernel_width];
	...
	FIX_INT8 local_weight_CONV3x3_S1[NUM_PE_CONV3x3_S1][OUT_CHAN_CONV3x3_S1][IN_CHAN_CONV3x3_S1][conv1_7x7_s2_kernel_height][conv1_7x7_s2_kernel_width];
				...
				for (int outer_ic_idx = 0; outer_ic_idx < conv1_7x7_s2_outer_in_channel; outer_ic_idx++) {
					...
					for (int global_weight_idx = 0; global_weight_idx < DIV_CEIL(global_weight_oc_num, OUT_CHANNEL_WEIGHT_GLOBAL_7x7); global_weight_idx++) {
						if (global_weight_idx < DIV_CEIL(global_weight_oc_num, OUT_CHANNEL_WEIGHT_GLOBAL_7x7) - 1)
							nnet::copy_weights_DDR2BRAM<DDR_weight_7x7_config, WEIGHT_GLOBAL_3x3_config>(DDR_weight_7x7, global_weight_7x7[conv1_7x7_s2_allocate_global_weight_7x7_start_idx + global_weight_idx],
					...
					int inner_height = DIV_CEIL((DDR_block_in_feature_h_start_idx + conv1_7x7_s2_pad_top + global_block_in_feature_h_num + inner_pad_bottom - KERNEL_HEIGHT_CONV3x3_S1) / (STRIDE_CONV3x3_S1)+1
						- DIV_CEIL(DDR_block_in_feature_h_start_idx + conv1_7x7_s2_pad_top, STRIDE_CONV3x3_S1),
						OUT_HEIGHT_CONV3x3_S1);
					int inner_width = DIV_CEIL((DDR_block_in_feature_w_start_idx + conv1_7x7_s2_pad_left + global_block_in_feature_w_num + inner_pad_right - KERNEL_WIDTH_CONV3x3_S1) / (STRIDE_CONV3x3_S1)+1
						- DIV_CEIL(DDR_block_in_feature_w_start_idx + conv1_7x7_s2_pad_left, STRIDE_CONV3x3_S1),
						OUT_WIDTH_CONV3x3_S1);
					if (outer_h_idx == 0) {
						inner_height = DIV_CEIL((DDR_block_in_feature_h_start_idx + global_block_in_feature_h_num + inner_pad_bottom + conv1_7x7_s2_pad_top - KERNEL_HEIGHT_CONV3x3_S1) / (STRIDE_CONV3x3_S1)+1
							- DIV_CEIL(DDR_block_in_feature_h_start_idx, STRIDE_CONV3x3_S1),
							OUT_HEIGHT_CONV3x3_S1);
					}
					if (outer_w_idx == 0) {
						inner_width = DIV_CEIL((DDR_block_in_feature_w_start_idx + global_block_in_feature_w_num + inner_pad_right + conv1_7x7_s2_pad_left - KERNEL_WIDTH_CONV3x3_S1) / (STRIDE_CONV3x3_S1)+1
							- DIV_CEIL(DDR_block_in_feature_w_start_idx, STRIDE_CONV3x3_S1),
							OUT_WIDTH_CONV3x3_S1);
					}
					int inner_out_channel = DIV_CEIL(global_weight_oc_num, conv1_7x7_s2_inner_pe_parallel*OUT_CHAN_CONV3x3_S1);
...
#pragma HLS unroll
										...
										int global_weight_oc_start_idx = (o_idx* conv1_7x7_s2_inner_pe_parallel + pe_idx) * OUT_CHAN_CONV3x3_S1;
										...
										if (o_idx == inner_out_channel - 1) {
											//handle the last iteration of the loop
											local_weight_oc_num = global_weight_oc_num - o_idx * OUT_CHAN_CONV3x3_S1*conv1_7x7_s2_inner_pe_parallel - OUT_CHAN_CONV3x3_S1 * pe_idx;
										}
										...
										if (outer_h_idx != 0) {
											global_in_feature_h_start_idx += (DDR_block_in_feature_h_start_idx + conv1_7x7_s2_pad_top) % STRIDE_CONV3x3_S1;
										}
										if (outer_w_idx != 0) {
											global_in_feature_w_start_idx += (DDR_block_in_feature_w_start_idx + conv1_7x7_s2_pad_left) % STRIDE_CONV3x3_S1;
										}
										...
										if (i_idx == 0) {
											if (outer_ic_idx == 0) {
												...
												nnet::set_bias<CONV3x3_S1_set_bias_config>(local_feature_out_CONV3x3_S1[pe_idx], DDR_bias+ conv1_7x7_s2_bias_DDR_offset + (conv1_7x7_s2_allocate_bias_start_idx + pe_idx + o_idx * conv1_7x7_s2_inner_pe_parallel + outer_oc_idx * conv1_7x7_s2_block_out_channel));
												//std::cout << "";
											}
											else {
												//restore partial sum
												...
												nnet::clear_buffer<CONV3x3_S1_local_feature_out_config>(local_feature_out_CONV3x3_S1[pe_idx]);
												nnet::copy_features_g2l<global_feature_config, CONV3x3_S1_local_feature_out_config>(global_feature[conv1_7x7_s2_allocate_global_out_feature_start_idx + global_out_feature_c_start_idx / CHANNEL_FEATURE_GLOBAL], local_feature_out_CONV3x3_S1[pe_idx],
										...
										nnet::copy_features_g2l<global_feature_config, CONV3x3_S1_local_feature_in_config>(global_feature[conv1_7x7_s2_allocate_global_in_feature_start_idx + global_in_feature_c_start_idx / CHANNEL_FEATURE_GLOBAL], local_feature_in_CONV3x3_S1[pe_idx],
										...
										nnet::copy_weights_g2l<WEIGHT_GLOBAL_3x3_config, CONV3x3_S1_local_weight_config>(global_weight_7x7[conv1_7x7_s2_allocate_global_weight_7x7_start_idx + global_weight_oc_start_idx / OUT_CHANNEL_WEIGHT_GLOBAL_7x7], local_weight_CONV3x3_S1[pe_idx],
										...
										if (i_idx == inner_in_channel - 1) {
											...
											nnet::copy_features_l2g<CONV3x3_S1_local_feature_out_config, global_feature_config>(local_feature_out_CONV3x3_S1[pe_idx], global_feature[conv1_7x7_s2_allocate_global_out_feature_start_idx + global_out_feature_c_start_idx / CHANNEL_FEATURE_GLOBAL],
					...
					if (outer_ic_idx == conv1_7x7_s2_outer_in_channel - 1)
					{
						...
						int DDR_block_out_feature_h_start_idx = DIV_CEIL((DDR_block_in_feature_h_start_idx + conv1_7x7_s2_pad_top), STRIDE_CONV3x3_S1);
						int DDR_block_out_feature_w_start_idx = DIV_CEIL((DDR_block_in_feature_w_start_idx + conv1_7x7_s2_pad_left), STRIDE_CONV3x3_S1);
						...
						int DDR_block_out_feature_h_num = (DDR_block_in_feature_h_start_idx + conv1_7x7_s2_pad_top + global_block_in_feature_h_num - KERNEL_HEIGHT_CONV3x3_S1) / STRIDE_CONV3x3_S1 + 1 - DDR_block_out_feature_h_start_idx;
						int DDR_block_out_feature_w_num = (DDR_block_in_feature_w_start_idx + conv1_7x7_s2_pad_left + global_block_in_feature_w_num - KERNEL_WIDTH_CONV3x3_S1) / STRIDE_CONV3x3_S1 + 1 - DDR_block_out_feature_w_start_idx;

						if (outer_h_idx == conv1_7x7_s2_outer_height - 1) {
							//handle the last iteration of the loop
							DDR_block_out_feature_h_num = (DDR_block_in_feature_h_start_idx + conv1_7x7_s2_pad_top + conv1_7x7_s2_pad_bottom + global_block_in_feature_h_num - KERNEL_HEIGHT_CONV3x3_S1) / STRIDE_CONV3x3_S1 + 1 - DDR_block_out_feature_h_start_idx;
						}
						if (outer_w_idx == conv1_7x7_s2_outer_width - 1) {
							//handle the last iteration of the loop
							DDR_block_out_feature_w_num = (DDR_block_in_feature_w_start_idx + conv1_7x7_s2_pad_left + conv1_7x7_s2_pad_right + global_block_in_feature_w_num - KERNEL_WIDTH_CONV3x3_S1) / STRIDE_CONV3x3_S1 + 1 - DDR_block_out_feature_w_start_idx;
						}
	...
	for (int outer_h_idx = 0; outer_h_idx < pool1_3x3_s2_outer_height; outer_h_idx++) {
		for (int outer_w_idx = 0; outer_w_idx < pool1_3x3_s2_outer_width; outer_w_idx++) {
			for (int outer_c_idx = 0; outer_c_idx < pool1_3x3_s2_outer_channel; outer_c_idx++) {
				...
				nnet::copy_features_DDR2BRAM_padding_zero<DDR_feature_conv1_7x7_s2_1_config, global_feature_config>(conv1_7x7_s2_1, global_feature[0],
