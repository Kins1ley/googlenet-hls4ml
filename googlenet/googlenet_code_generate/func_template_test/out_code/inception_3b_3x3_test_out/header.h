...
/////header_insert_1/////
const int IMAGE_CH = 128; // image channel
const int IMAGE_H = 28;// image height
const int IMAGE_W = 28;// image width
/*
...
const int conv1_7x7_s2_pad_top = 1;
const int conv1_7x7_s2_pad_bottom = 1;
const int conv1_7x7_s2_pad_left = 1;
const int conv1_7x7_s2_pad_right = 1;
const int conv1_7x7_s2_kernel_num = 192;
const int conv1_7x7_s2_kernel_channel = conv1_7x7_s2_in_channel;
const int conv1_7x7_s2_kernel_channel_DDR_offset = 0;
const int conv1_7x7_s2_kernel_height = 3;
const int conv1_7x7_s2_kernel_width = 3;
...
const int conv1_7x7_s2_out_height = 28;
const int conv1_7x7_s2_out_width = 28;
