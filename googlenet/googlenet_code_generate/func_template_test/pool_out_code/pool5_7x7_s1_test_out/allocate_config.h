...
///overlapped features between blocks
const int pool1_3x3_s2_block_overlap_height = KERNEL_HEIGHT_AVGPOOL7x7_S1 - 1;
const int pool1_3x3_s2_block_overlap_width = KERNEL_WIDTH_AVGPOOL7x7_S1 - 1;
///number of blocks(the dims of the outer loop)
...
///interval between blocks
const int pool1_3x3_s2_block_interval_height = DIV_CEIL(DIV_CEIL(pool1_3x3_s2_in_height, pool1_3x3_s2_outer_height), STRIDE_AVGPOOL7x7_S1)*STRIDE_AVGPOOL7x7_S1;//the spacing between blocks
const int pool1_3x3_s2_block_interval_width = DIV_CEIL(DIV_CEIL(pool1_3x3_s2_in_width, pool1_3x3_s2_outer_width), STRIDE_AVGPOOL7x7_S1)*STRIDE_AVGPOOL7x7_S1;
///dim of blocks
...
///set parallism
const int pool1_3x3_s2_inner_pe_parallel = NUM_PE_AVGPOOL7x7_S1;
///dim of kernels
