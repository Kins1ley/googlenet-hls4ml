...
const int conv1_7x7_s2_block_overlap_height = KERNEL_HEIGHT_CONV1x1_S1 - 1;
const int conv1_7x7_s2_block_overlap_width = KERNEL_WIDTH_CONV1x1_S1 - 1;
///number of blocks(the dims of the outer loop)
const int conv1_7x7_s2_outer_in_channel = DIV_CEIL(conv1_7x7_s2_in_channel, conv1_7x7_s2_allocate_global_in_feature_num*CHANNEL_FEATURE_GLOBAL < IN_CHANNEL_WEIGHT_GLOBAL_1x1 ? conv1_7x7_s2_allocate_global_in_feature_num * CHANNEL_FEATURE_GLOBAL : IN_CHANNEL_WEIGHT_GLOBAL_1x1);
...
const int conv1_7x7_s2_block_interval_height = DIV_CEIL(DIV_CEIL(conv1_7x7_s2_in_height, conv1_7x7_s2_outer_height), STRIDE_CONV1x1_S1)*STRIDE_CONV1x1_S1;//the spacing between blocks
const int conv1_7x7_s2_block_interval_width = DIV_CEIL(DIV_CEIL(conv1_7x7_s2_in_width, conv1_7x7_s2_outer_width), STRIDE_CONV1x1_S1)*STRIDE_CONV1x1_S1;
///dim of blocks
...
const int conv1_7x7_s2_block_in_channel = MIN(conv1_7x7_s2_allocate_global_in_feature_num*CHANNEL_FEATURE_GLOBAL , IN_CHANNEL_WEIGHT_GLOBAL_1x1);
///set parallism
const int conv1_7x7_s2_inner_pe_parallel = NUM_PE_CONV1x1_S1;
///dim of kernels
const int conv1_7x7_s2_block_out_channel = MIN(conv1_7x7_s2_allocate_global_out_feature_num*CHANNEL_FEATURE_GLOBAL , conv1_7x7_s2_allocate_global_weight_7x7_num*OUT_CHANNEL_WEIGHT_GLOBAL_1x1);
