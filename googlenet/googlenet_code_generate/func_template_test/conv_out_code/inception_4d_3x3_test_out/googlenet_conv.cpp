				...
				for (int ic_idx = 0; ic_idx < conv1_7x7_s2_in_channel; ++ic_idx) {
					...
					for (int kh_idx = 0; kh_idx < conv1_7x7_s2_kernel_height; ++kh_idx) {
						for (int kw_idx = 0; kw_idx < conv1_7x7_s2_kernel_width; ++kw_idx) {
							if (oh_idx*STRIDE_CONV3x3_S1 + kh_idx - conv1_7x7_s2_pad_top < 0) continue;
							if (oh_idx*STRIDE_CONV3x3_S1 + kh_idx - conv1_7x7_s2_pad_top >= conv1_7x7_s2_in_height) continue;
							if (ow_idx*STRIDE_CONV3x3_S1 + kw_idx - conv1_7x7_s2_pad_left < 0) continue;
							if (ow_idx*STRIDE_CONV3x3_S1 + kw_idx - conv1_7x7_s2_pad_left >= conv1_7x7_s2_in_width) continue;
							outputs[oc_idx * conv1_7x7_s2_out_height * conv1_7x7_s2_out_width + oh_idx * conv1_7x7_s2_out_width + ow_idx] += (FIX_INT20)(inputs[ic_idx * conv1_7x7_s2_in_height * conv1_7x7_s2_in_width+(oh_idx*STRIDE_CONV3x3_S1 + kh_idx - conv1_7x7_s2_pad_top) * conv1_7x7_s2_in_width +ow_idx*STRIDE_CONV3x3_S1 + kw_idx - conv1_7x7_s2_pad_left]
