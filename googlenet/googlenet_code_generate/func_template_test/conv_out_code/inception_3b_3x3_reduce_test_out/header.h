...
/////header_insert_1/////
const int IMAGE_CH = 256; // image channel
...
const int conv1_7x7_s2_pad_top = 0;
const int conv1_7x7_s2_pad_bottom = 0;
const int conv1_7x7_s2_pad_left = 0;
const int conv1_7x7_s2_pad_right = 0;
const int conv1_7x7_s2_kernel_num = 128;
const int conv1_7x7_s2_kernel_channel = conv1_7x7_s2_in_channel;
const int conv1_7x7_s2_kernel_channel_DDR_offset = 0;
const int conv1_7x7_s2_kernel_height = 1;
const int conv1_7x7_s2_kernel_width = 1;
