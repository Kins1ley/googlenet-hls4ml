...
struct {pool_layer_type}_local_feature_in_config : nnet::Feature_Memory {left_bracket}
	typedef FIX_INT20 feature_type;
	static const unsigned channel = N_CHAN_{pool_layer_type};
	static const unsigned height = IN_HEIGHT_{pool_layer_type};
	static const unsigned width = IN_WIDTH_{pool_layer_type};
{right_bracket};
struct {pool_layer_type}_local_feature_out_config : nnet::Feature_Memory {left_bracket}
	typedef FIX_INT20 feature_type;
	static const unsigned channel = N_CHAN_{pool_layer_type};
	static const unsigned height = OUT_HEIGHT_{pool_layer_type};
	static const unsigned width = OUT_WIDTH_{pool_layer_type};
{right_bracket};
/////////////template_config /////////////
